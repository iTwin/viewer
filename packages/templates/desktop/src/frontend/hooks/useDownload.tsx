...
import { NativeApp , type OnDownloadProgress} from "@itwin/core-frontend";
...
export const useDownload = (
  ...
  const doDownload = useCallback(async () => {
    ...
    if (fileName) {
      const progressCallback: OnDownloadProgress = (localProgress) => {
        const { loaded, total } = localProgress;
