...
/**
 * Clone of StandardNavigationToolsProvider from core appui-react, but using the View.LookAndMove tool.
 */
...
export class StandardNavigationToolsProvider extends BaseUiItemsProvider {
  ...
  constructor(
    providerId: string,
    private defaultNavigationTools?: DefaultNavigationTools,
    isSupportedStage?: (
      stageId: string,
      stageUsage: string,
      stageAppData?: any
