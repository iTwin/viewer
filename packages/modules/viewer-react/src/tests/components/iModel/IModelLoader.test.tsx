...
describe("IModelLoader", () => {
  ...
  it("creates a default viewstate", async () => {
    ...
    const result = render(
      <IModelLoader iTwinId={mockContextId} iModelId={mockIModelId} />
    );
  ...
  it("closes connection between model ids change", async () => {
    ...
    result.rerender(
      <IModelLoader iTwinId={mockContextId} iModelId={mockIModelId + "1"} />
    );
  ...
  it("closes connection between context ids change", async () => {
    ...
    result.rerender(
      <IModelLoader iTwinId={mockContextId + "1"} iModelId={mockIModelId} />
    );
